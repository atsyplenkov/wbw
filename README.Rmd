...
The `wbw` R package introduces several new S7 classes, `WhiteboxRaster` and
...
> While the `{wbw}` requires the `whitebox-workflows` Python library v1.3.3+. It is designed to install all the dependencies automatically.
