...
![WBW Functions](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/atsyplenkov/0c46250def94614c4a3ef8b4de7460e6/raw/wbw-progress.json)
...
The `wbw` R package introduces several new S7 classes, `WhiteboxRaster` and `WhiteboxVector`
